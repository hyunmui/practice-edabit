...
public class PigLatinTranslatorTests {
  ...
  @Test
  public void test14() {
    assertEquals("Iyay ikelay otay eatyay oneyhay afflesway",
        Challenge.translateSentence("I like to eat honey waffles"));
  }

  @Test
  public void test15() {
    assertEquals("Oday ouyay inkthay ityay isyay oinggay otay ainray odaytay?",
        Challenge.translateSentence("Do you think it is going to rain today?"));
  }

  @Test
  public void test16() {
    assertEquals("Ehay aidsay, \"Enwhay illway isthay allyay endyay?\"",
        Challenge.translateSentence("He said, \"When will this all end?\""));
  }
