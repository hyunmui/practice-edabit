...
public class CumulativeArraySumTests {
    ...
    public void test6() {
        ...
        assertThat(Program.cumulativeSum(new int[] { 3, 3, -2, 408, 3, 3, 0, 66, 2, -2, 2, 3, 4, 2, -47, 3, 3, 2 }),
                is(new int[] { 3, 6, 4, 412, 415, 418, 418, 484, 486, 484, 486, 489, 493, 495, 448, 451, 454, 456 }));
    }
}